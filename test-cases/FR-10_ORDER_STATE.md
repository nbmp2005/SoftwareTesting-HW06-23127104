...
| `FR10-AI-033` | `AI` | FR-10; SEC-02; API §4.6 | Security, auth | P0 | No authenticated actor; `O-P=pending` | User cancel API with no `Authorization` header | `401` per ASM-05; generic JSON error; order unchanged | Restore snapshots |  |  |  | `PASS` |
